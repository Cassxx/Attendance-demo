...
public class AttendancePage extends Activity implements View.OnClickListener{
...
//        SearchToday();
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.go_work_img_btn){
            ...
            builder.setNegativeButton("正常",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (checkWifi(AttendancePage.this)==1){
                                Toast.makeText(AttendancePage.this,"您连接的是移动网络,签到失败!",Toast.LENGTH_SHORT).show();
                            }else if (checkWifi(AttendancePage.this)==3){
                                Toast.makeText(AttendancePage.this,"您没有连接网络,签到失败!",Toast.LENGTH_SHORT).show();
                            }else if (checkWifi(AttendancePage.this)==2) {
            ...
            builder.setPositiveButton("请假",
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            if (checkWifi(AttendancePage.this)==3) {
                                Toast.makeText(AttendancePage.this, "您没有连接网络,签出失败!", Toast.LENGTH_SHORT).show();
                            }else{
                                ...
                                if (isAlreadySignInList.size()==0) {
                                    ...
                                    signIn.save(new SaveListener<String>() {
                                        ...
                                        public void done(String s, BmobException e) {
                                            if (e==null){
                                                Toast.makeText(AttendancePage.this, "请假成功!", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }else{
                                    Toast.makeText(AttendancePage.this, "请假失败!今天已经签到过了", Toast.LENGTH_SHORT).show();
                                }
                            }
        ...
        if (id == R.id.off_work_img_btn){
            if (checkWifi(AttendancePage.this)==1){
                Toast.makeText(AttendancePage.this,"您连接的是移动网络,签出失败!",Toast.LENGTH_SHORT).show();
            }else if (checkWifi(AttendancePage.this)==3){
                Toast.makeText(AttendancePage.this,"您没有连接网络,签出失败!",Toast.LENGTH_SHORT).show();
            }else if (checkWifi(AttendancePage.this)==2) {
                IP = getLocalIpAddress();
        ...
        if (id == R.id.sign_details){
            ...
            Intent intent = new Intent(AttendancePage.this,MonthCalendarActivity.class);
    ...
    public void isLate(List<SignListByMonth> signListByMonths) {
        long InTIme = 90000L;
            if (signListByMonths.size() != 0) {
                Toast.makeText(AttendancePage.this, "签到失败!今天已经签到过了", Toast.LENGTH_SHORT).show();
            }else{
//                BmobQuery query = new BmobQuery("SignIn");
                Date now = new Date(System.currentTimeMillis());
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    if (isAlreadySignInList.size()>0){
                        ...
                        new AlertDialog.Builder(AttendancePage.this).setTitle("提示").setMessage("你已经迟到了!")
...
//                                            finish();
                        ...
                        Toast.makeText(AttendancePage.this, "签到成功!\n IP:" + IP + "\nMAC 地址:" + MAC + "\n时间:" + ytime, Toast.LENGTH_LONG).show();
//                            mButton_signIn.setClickable(false);
//                            mButton_signOut.setClickable(true);
                    }
                } else {
                    Toast.makeText(AttendancePage.this, "签到失败!", Toast.LENGTH_SHORT).show();
                }
            }
...
//                            mButton_signOut.setClickable(true);
            ...
            public void done(List<SignOut> list, BmobException e) {
                if (e == null) {
                    for (SignOut signOut : list) {
                        ...
                        signListByMonth.setCheckDate(checkDate);
                        String signTime = signOut.getCreatedAt();
                        signListByMonth.setSignTime(signTime);
    ...
    public void isEarly(List<SignListByMonth> signListByMonths) {
        ...
        if (signListByMonths.size() != 0) {
            Toast.makeText(AttendancePage.this, "签出失败!今天已经签出过了", Toast.LENGTH_SHORT).show();
        }else{
            Date now = new Date(System.currentTimeMillis());
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String nowTime = simpleDateFormat.format(now);
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    if (isAlreadySignOutList.size()>0){
                        ...
                        Toast.makeText(AttendancePage.this, "签出成功!\n IP:" + IP + "\nMAC 地址:" + MAC + "\n时间:" + ytime, Toast.LENGTH_LONG).show();
//                            mButton_signIn.setClickable(false);
//                            mButton_signOut.setClickable(true);
                    }
                } else {
                    Toast.makeText(AttendancePage.this, "签出失败!", Toast.LENGTH_SHORT).show();
                }
            }
